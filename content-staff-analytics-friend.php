<div class="col-sm-3">
    <div class="form-group" style="border-left:4px solid #3498db; padding:10px 10px 10px 15px;margin-bottom:25px;background:#f9f9f9;">
    ...
    right: 10px;
    top: -5px;
    z-index: 9;">Khảo sát lỗi, vui lòng liên hệ Sĩ (Bộ phận IT)</span>
             <?php } ?>

      <span class="label label-info" style="font-weight:lighter;">      đã giới thiệu <strong><?php the_field('quest_20'); ?></strong> [<?php the_field('quest_21'); ?>]</span></p>
            

        <a href="#" data-toggle="modal" data-target="#nv_gt_<?php the_ID();?>" style="color:#3498db;">Xem thông tin chi tiết</a> 
        
        <!-- detail --> 
        
        <!-- Modal -->
        <div id="nv_gt_<?php the_ID();?>" class="modal fade" role="dialog">
    ...
    z-index: 9;">Giới thiệu người quen</span>
             <?php } ?>
                    ...
                    <div class="modal-body while_content"> 
                       ...
                       <strong> <?php the_title(); ?></strong> đã giới thiệu <strong><?php the_field('quest_20'); ?></strong> tham gia làm việc tại GKD
                        </div>
                        <div  style="border-left:4px solid #3498db; padding-left:15px;margin-bottom:25px;">
                        <hr>
