<div class="col-sm-3">
    ...
    z-index: 9;">GT</span>
        ...
        <a href="#" data-toggle="modal" data-target="#nv_<?php the_ID();?>" style="color: <?php if(get_field('quest_02')=='Có') { echo '#8dc73f'; } else { echo '#e74c3c'; } ?>">Xem thông tin chi tiết</a> 
        
        <!-- detail --> 
        
        <!-- Modal -->
        <div id="nv_<?php the_ID();?>" class="modal fade" role="dialog">
             ...
             <?php } ?>
                    ...
                    <div class="modal-body while_content"> 
                      ...
                      <?php } else {?>
                       ...
                       <strong> <?php the_title(); ?></strong> đã giới thiệu <strong><?php the_field('quest_20'); ?></strong> tham gia làm việc tại GKD, <a href="#" data-toggle="collapse" data-target="#nguoiduocgioithieu_<?php the_ID();?>" style="text-decoration:underline;">Xem thông tin của <?php the_field('quest_20'); ?></a>
                        </div>
                        <div id="nguoiduocgioithieu_<?php the_ID();?>" class="collapse" style="border-left:4px solid #8dc73f; padding-left:15px;margin-bottom:25px;">
                        <hr>
